...
/**
 Base class for all Navi_Tour views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Navi_Tour view hierarchy (such as wrapped iOS UIViews) was touched.
