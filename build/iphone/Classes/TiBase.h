...
// in simulator we redefine to format for Navi_Tour Developer console
...
{\
	NSString * exceptionName = [@"org.navi_tour." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.navi_tour";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINavi_TourNativeItemNone = -1, 
	UINavi_TourNativeItemSpinner = -2,
	UINavi_TourNativeItemProgressBar = -3,
	
	UINavi_TourNativeItemSlider = -4,
	UINavi_TourNativeItemSwitch = -5,
	UINavi_TourNativeItemMultiButton = -6,
	UINavi_TourNativeItemSegmented = -7,
	
	UINavi_TourNativeItemTextView = -8,
	UINavi_TourNativeItemTextField = -9,
	UINavi_TourNativeItemSearchBar = -10,
	
	UINavi_TourNativeItemPicker = -11,
	UINavi_TourNativeItemDatePicker = -12,
	
	UINavi_TourNativeItemInfoLight = -13,
	UINavi_TourNativeItemInfoDark = -14,
	
	UINavi_TourNativeItemDisclosure = -15,
	
	UINavi_TourNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Navi_Tour instances of
