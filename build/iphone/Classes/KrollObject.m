...
//@interface Navi_TourObject : NSObject
//@end

@interface Navi_TourObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Navi_TourObject class]])
		{
			for (NSString *key in [[(Navi_TourObject*)o modules] allKeys])
			{
