...
/**
 The base class for all Navi_Tour modules
 */
...
/**
 Navi_Tour Platform calls this method on startup.
 */
-(void)startup;

/**
 Navi_Tour Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Navi_Tour Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Navi_Tour Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Navi_Tour Platform calls this method on resume.
 @param sender The sender of the event.
 */
