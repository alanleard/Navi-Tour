...
@interface Navi_TourObject : KrollCoverageObject {
#else
@interface Navi_TourObject : KrollObject {
#endif
@private
...
extern NSString * Navi_Tour$ModuleRequireFormat;
